...
def window():
   ...
   turnButton.clicked.connect(lambda: turnButton_clicked(settings["printer_name"], 
                                                         ...
                                                         settings["debug_mode"],
                                                         screenH, screenW,
                                                         settings["wait_box_timeout"],
                                                         settings["wait_box_title"],
                                                         settings["wait_box_text"],
                                                         widget))
...
def turnButton_clicked(printerName, turnLabel, storeName, debugMode, screenH, screenW, timeout, boxTitle, botText, widget):
   ...
   msg = CustomMessageBox.showWithTimeout(timeout, botText, boxTitle, QMessageBox.Warning, screenH, screenW)
